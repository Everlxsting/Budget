...
import org.larin.budget.data.spec.TxSpecs;
...
public class TransactionSpecTest {
    ...
    public void createdAfterWorks() {
        ...
        createDeposit(acc, 20d, "2023-12-03T10:15:30+03:00");
        createDeposit(acc, 14d, "2023-12-04T01:00:30+03:00");
        createDeposit(acc, 12d, "2023-12-04T05:00:30+03:00");

        List<Transaction> result = txRepo.findAll(TxSpecs.createdAfter(parse("2023-12-04T01:01:30+03:00")), Sort.by("createDate"));
        List<Transaction> result2 = txRepo.findAll(TxSpecs.createdAfter(parse("2023-12-03T11:01:30+03:00")), Sort.by("createDate"));
    ...
    public void hasCategoryWorks() {
        ...
        createDeposit(acc, 20d, "2023-12-03T10:15:30+03:00");
        DepositTx d2 = createDeposit(acc, 14d, "2023-12-04T01:00:30+03:00");
        createDeposit(acc, 12d, "2023-12-04T05:00:30+03:00");
